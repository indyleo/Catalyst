...
git_clone https://github.com/zsh-users/zsh-syntax-highlighting.git "${PLUGINS_DIR}"/zsh-syntax-highlighting
git_clone https://github.com/zsh-users/zsh-autosuggestions.git "${PLUGINS_DIR}"/zsh-autosuggestions
